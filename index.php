...
<head>
    ...
    <link rel="stylesheet" href="css/countdown.css?v=3.0">
    <link rel="stylesheet" href="css/news.css?v=3.0">
    <link rel="stylesheet" href="css/mobile.css?v=4.0" media="screen and (max-width: 768px)">
</head>
<body>
    <header>
        <div class="container">
